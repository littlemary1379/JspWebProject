...
<div class="container h-100 col-md-6">
	...
	<form class="form col-md-12" method="post" action="/DailyT/order?cmd=UserOrder">
...
<div class="container h-100 col-md-6">
	<p>비회원으로 주문시 다양한 혜택에서 제외됩니다.</p>
	<button class="col-md-12" onclick="location.href='/DailyT/order?cmd=nonUserOrder'">비회원 구매</button>
	<br/>
</div>