	...
	<div class="container-fluid">
		...
		<div class="nav2">
			<nav class="navbar navbar-menu navbar-expand-sm">
				...
				<ul class="navbar-nav">
					<li class="nav-item"><a class="nav-link" href="#"><img src="img/dailyT-100px.png" alt="Logo" style="width: 40px;"></a></li>
					<li class="nav-item2 col-md-4"><a class="nav-link" href="#">브랜드 스토리</a>
					...
					<li class="nav-item5 col-md-4"><a class="nav-link" href="#" id="navbardrop" data-toggle="dropdown">도구</a>
						<div class="dropdown-menu">
							<a class="dropdown-item" href="#">스타터팩</a> <a class="dropdown-item" href="#">다구</a>
						</div></li>

					<li class="nav-item  col-md-4"><a class="nav-link" href="#">이벤트</a></li>
				</ul>
			</nav>
		</div>
	</div>
